const HeroSection = () => (
  <section className="w-full bg-gradient-to-b from-purple-100 to-indigo-100 py-20 lg:py-32">
    <div className="container mx-auto flex flex-col items-center text-center gap-8">
      ...
      <button className="rounded-xl bg-indigo-600 px-8 py-4 text-lg font-bold text-white shadow-lg hover:scale-105 hover:bg-indigo-700 transition-transform">
